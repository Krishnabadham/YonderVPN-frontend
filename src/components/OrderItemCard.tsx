...
import { useUpdateMyVpnOrder } from "@/api/MyVpnApi";
...
const OrderItemCard = ({order}: Props) => {
    const {updateVpnStatus, isLoading} = useUpdateMyVpnOrder();
    ...
    const handleStatusChange = async (newStatus: OrderStatus) => {
        await updateVpnStatus({orderId:order._id as string, status: newStatus});
        setStatus(newStatus);
    };
    return(
        <Card>
